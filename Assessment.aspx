...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .btn { padding: 9px 18px; color: #fff; border: none; border-radius: 7px; font-size: 13px; cursor: pointer; }
        ...
        <div class="main">
            ...
            <asp:Panel ID="pnlTable" runat="server" Visible="false">
                ...
                <div class="table-toolbar">
                    ...
                    <div>
                        <asp:Button ID="btnEditStructure" runat="server" Text="Edit Assessment Columns"
                            CssClass="btn btn-blue" OnClick="btnEditStructure_Click" />
                ...
                <asp:Panel ID="pnlAddAssessment" runat="server" Visible="false">
                    <div class="filter-card">
                        <div class="filter-row">
                            <div class="filter-group">
                ...
                <div class="table-card">
                    ...
                    <div class="table-footer">
                        <span>Enter obtained marks. Total percentage is calculated automatically.</span>
                        <span>Use the exact name Final Exam to limit it to one final exam.</span>
                    </div>
                </div>
            </asp:Panel>
        </div>
