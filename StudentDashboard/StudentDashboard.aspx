...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="bg-topbar-gradient h-[189px] w-full">
        <h2 class="text-[48px] font-bold text-white px-6 py-[90px] text-shadow">Dashboard</h2>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 mb-8">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Welcome back, <asp:Label ID="lblStudentName" runat="server" />!</h1>
                    <p class="text-gray-600 mt-1"><asp:Label ID="lblProgramme" runat="server" /> | Student ID: <asp:Label ID="lblStudentID" runat="server" /></p>
                </div>
                <asp:HyperLink ID="hlEditProfile" runat="server" NavigateUrl="~/Student/StudentSetting/StudentSetting.aspx" CssClass="mt-3 sm:mt-0 text-indigo-600 hover:text-indigo-800">Edit Profile →</asp:HyperLink>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                    ...
                    <!-- "No courses" message (shown/hidden from code-behind) -->
                    ...
                    <div class="p-4">
                        <div class="mb-4">
                            ...
                            <div class="w-full bg-gray-200 rounded-full h-2">
                                <div class="bg-green-600 h-2 rounded-full" style='width: <%# GetAttendanceBarWidth() %>'></div>
                            </div>
                        </div>
                        <div class="space-y-2">
                            <asp:Repeater ID="rptAttendanceByCourse" runat="server">
                                <ItemTemplate>
                                    <div class="flex justify-between text-sm">
                                        <span class="text-gray-700"><%# Eval("CourseCode") %></span>
                                        <span class="text-gray-600"><%# Eval("AttendancePercentage") %>%</span>
                                    </div>
                                </ItemTemplate>
                            </asp:Repeater>
                        </div>
            ...
            <div class="space-y-8">
                ...
                <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                    ...
                    <!-- "No notifications" message (shown/hidden from code-behind) -->
