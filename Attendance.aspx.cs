<<<<<<< Updated upstream:Attendance.aspx.cs
﻿using System;
using System.Data;
...
namespace LecturerPortal
{
    public partial class Attendance : Page
    {
        ...
        protected void btnLoad_Click(object sender, EventArgs e)
        {
            ...
            // Load enrolled students with their existing attendance for this date
            string query = @"
        ...
        // Pre-tick checkboxes for existing attendance records
        protected void rptStudents_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                DataRowView row = (DataRowView)e.Item.DataItem;
                string existingStatus = row["AttendanceStatus"] == DBNull.Value
                    ? null
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            foreach (RepeaterItem item in rptStudents.Items)
            {
                ...
                // Get StudentID from the data-id attribute via a hidden label
                // We embed it in the repeater as a hidden field
                var hiddenID = item.FindControl("hfStudentID") as HiddenField;
                ...
                string status = chkPresent.Checked ? "Present"
                              ...
                              : "Absent"; // Default to Absent if none ticked
...
>>>>>>> Stashed changes:StudentManagementSystem/Lecturer Portal/Attendance.aspx.cs
}