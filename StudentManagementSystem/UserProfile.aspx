            ...
            <div class="max-w-6xl mx-auto px-4 sm:px-8 relative -mt-10 z-10">
                ...
                <div class="flex flex-col md:flex-row items-center md:items-center justify-between gap-6 mb-8">
                    <div class="flex flex-col md:flex-row items-center md:items-center gap-5 text-center md:text-left">
                        <div class="relative w-36 h-36 rounded-full border-4 border-white shadow-md overflow-hidden bg-white shrink-0 group">
                            <asp:Image ID="imgAvatar" runat="server" ImageUrl="~/images/profile_upload/default-avatar.jpg" CssClass="w-full h-full object-cover" />
                            <asp:Panel ID="pnlAvatarOverlay" runat="server" Visible="false" CssClass="absolute inset-0 bg-black/40 flex items-center justify-center transition-opacity">
                ...
                <div class="bg-white rounded-2xl border border-gray-200/80 p-6 md:p-10 shadow-sm min-h-[400px]">
                    ...
                    <asp:Panel ID="pnlUploadControls" runat="server" Visible="false" CssClass="bg-gray-50 border border-gray-200 p-5 rounded-xl mb-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider">Upload Profile Photo</label>
                            <div class="flex items-center gap-2">
                                <asp:FileUpload ID="fuAvatar" runat="server" CssClass="text-xs text-gray-500 file:mr-4 file:py-1.5 file:px-3 file:rounded-md file:border-0 file:text-xs file:font-semibold file:bg-gray-900 file:text-white hover:file:bg-gray-800 cursor-pointer flex-1" />
                                <asp:LinkButton ID="lnkDeleteAvatar" runat="server" OnClick="lnkDeleteAvatar_Click" OnClientClick="return confirm('Revert and remove your custom uploaded profile picture?');"
                                    CssClass="bg-red-50 hover:bg-red-100 text-red-600 p-2 rounded-lg border border-red-200 text-xs font-medium flex items-center gap-1 transition-colors">
                        ...
                        <div class="space-y-2">
                            <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider">Upload Background Banner Image</label>
                            <div class="flex items-center gap-2">
                                <asp:FileUpload ID="fuBackground" runat="server" CssClass="text-xs text-gray-500 file:mr-4 file:py-1.5 file:px-3 file:rounded-md file:border-0 file:text-xs file:font-semibold file:bg-gray-900 file:text-white hover:file:bg-gray-800 cursor-pointer flex-1" />
                                <asp:LinkButton ID="lnkDeleteBanner" runat="server" OnClick="lnkDeleteBanner_Click" OnClientClick="return confirm('Revert your workspace background back to the system default gradient?');"
                                    CssClass="bg-red-50 hover:bg-red-100 text-red-600 p-2 rounded-lg border border-red-200 text-xs font-medium flex items-center gap-1 transition-colors">
                                    <i class="fa-solid fa-trash-can"></i> Reset
                                </asp:LinkButton>
                            </div>
                    ...
                    <div class="space-y-6 max-w-3xl">
                        ...
                        <div>
                            <label class="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Registered Name</label>
                        ...
                        <div>
                            <label class="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Email / Username</label>
                        ...
                        <asp:Panel ID="pnlPasswordBlock" runat="server" Visible="false" class="pt-2">
                            <label class="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Change Password</label>
