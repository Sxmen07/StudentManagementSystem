...
namespace StudentManagementSystem
{
    public partial class AuditAttendance : System.Web.UI.Page
    {
        ...
        private DataTable FetchFilteredAttendanceData()
        {
            ...
            using (SqlConnection conn = new SqlConnection(connString))
            {
                StringBuilder sb = new StringBuilder("SELECT SchoolName, ProgrammeName, CourseCode, CourseName, LecturerName, StudentRoleID, StudentName, AttendanceStatus FROM Vw_AdminAttendanceRegistry WHERE 1=1");
