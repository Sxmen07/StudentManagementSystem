<%@ Page Title="Course Material" Language="C#" MasterPageFile="~/Student/StudentNavigationBar/StudentMaster.master" AutoEventWireup="true" CodeBehind="StudentCourseMaterial.aspx.cs" Inherits="StudentManagementSystems.Student.StudentCourseMaterial" %>
                            ...
                            <ItemTemplate>
                                <tr class="material-row" data-type='<%# GetMaterialType(Eval("Title").ToString()) %>'>
                                    ...
                                    <td class="px-8 py-4 whitespace-nowrap text-sm text-center space-x-3">
                                        ...
                                        <a href='<%# Eval("FileUrl") %>' download class="text-gray-600 hover:text-indigo-600 transition-colors duration-200" title="Download">
