...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <header class="bg-topbar-gradient w-full">
        <div class="px-4 sm:px-6 lg:px-8 py-8 sm:py-10 lg:py-12">
            <h1 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold animate-welcome">My Attendance Records</h1>
            <p class="text-sm mt-1">Stay on track – monitor your attendance across all courses</p>
        </div>
    </header>

    <!-- DOWNLOAD BAR - aligned to the right, below header -->
    <div class="w-full px-4 sm:px-6 lg:px-8 py-3 bg-white border-b border-gray-200 flex flex-wrap items-center justify-end gap-3 mt-2">
    ...
    <script type="text/javascript">
        function getVisibleContainer() {
            var currentPanel = document.getElementById('<%= pnlCurrent.ClientID %>');
            var historyPanel = document.getElementById('<%= pnlHistory.ClientID %>');
        ...
        // ASP.NET AJAX Lifecycle handler to run initialization scripts after every partial postback
